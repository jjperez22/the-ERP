...
export type OrderStatus = 'draft' | 'pending_approval' | 'approved' | 'picking' | 'packed' | 'shipped' | 'delivered' | 'invoiced' | 'paid' | 'cancelled';
...
export type PurchaseOrderStatus = 'draft' | 'pending_approval' | 'approved' | 'sent' | 'acknowledged' | 'partially_received' | 'received' | 'closed' | 'cancelled';
...
export type InsightType = 'demand_forecast' | 'inventory_optimization' | 'price_opportunity' | 'supplier_risk' | 'customer_churn' | 'cash_flow_prediction' | 'seasonal_trend';
...
//# sourceMappingURL=erp_data_models.d.ts.map